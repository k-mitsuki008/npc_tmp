...
class paymentsWafConstruct(Construct):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        #管理者用webaclの作成
        adminwaf=waf.CfnWebACL(
            self,
            "adminwaf",
            name=f"{env_name}-{phase}-webacl-admin-hosting",
            default_action=waf.CfnWebACL.DefaultActionProperty(
                allow={}
            ),
            scope="CLOUDFRONT",
            ...
            rules=[
                ...
                waf.CfnWebACL.RuleProperty(
                    name=f"{env_name}-{phase}-webacl-admin-ips-rule",
                    priority=3,
                    action=waf.CfnWebACL.RuleActionProperty(
                        block={}
                    ),
